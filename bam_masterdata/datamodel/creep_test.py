from bam_masterdata.datamodel.object_types import ExperimentalStep, Sample, Instrument
...
class CreepTest(MechanicalTest):
    ...
    link_test_piece = PropertyTypeAssignment(
        ...
        data_type="OBJECT",
        object_code="CREEP_TEST_TEST_PIECE",
    ...
    link_test_machine = PropertyTypeAssignment(
        ...
        data_type="OBJECT",
        object_code="CREEP_TEST_TEST_MACHINE",
    ...
    link_load_sensor = PropertyTypeAssignment(
        ...
        data_type="OBJECT",
        object_code="CREEP_TEST_LOAD_SENSOR",
    ...
    link_laboratory_conditions = PropertyTypeAssignment(
        ...
        data_type="OBJECT",
        object_code="CREEP_TEST_LABORATORY_CONDITIONS",
    ...
    link_temperature_measuring_system = PropertyTypeAssignment(
        ...
        data_type="OBJECT",
        object_code="CREEP_TEST_TEMPERATURE_MEASURING_SYSTEM",
    ...
    link_temperature_sensor = PropertyTypeAssignment(
        ...
        data_type="OBJECT",
        object_code="CREEP_TEST_TEMPERATURE_SENSOR",
    ...
    link_temperature_daq = PropertyTypeAssignment(
        ...
        data_type="OBJECT",
        object_code="CREEP_TEST_TEMPERATURE_DATA_ACQUISITION",
    ...
    link_extensometer_system = PropertyTypeAssignment(
        ...
        data_type="OBJECT",
        object_code="CREEP_TEST_EXTENSOMETER_SYSTEM",
    ...
    link_contacting_extensometer = PropertyTypeAssignment(
        ...
        data_type="OBJECT",
        object_code="CREEP_TEST_EXTENSION_VALUES_CONTACTING_EXTENSOMETER",
    ...
    link_elongation_cross_sectional = PropertyTypeAssignment(
        ...
        data_type="OBJECT",
        object_code="CREEP_TEST_ELONGATION_VALUES_AND_CROSS_SECTIONAL_DIMENSIONS",
    ...
    link_primary_data_during_run = PropertyTypeAssignment(
        ...
        data_type="OBJECT",
        object_code="CREEP_TEST_PRIMARY_VALUES_RECORDED_DURING_TEST_RUN",
    ...
    link_secondary_data_during_run = PropertyTypeAssignment(
        ...
        data_type="OBJECT",
        object_code="CREEP_TEST_SECONDARY_VALUES_RECORDED_DURING_TEST_RUN",
...
class CreepTestMaterialHistoryAndCondition(ObjectType):
    ...
    link_ndt_results = PropertyTypeAssignment(
        ...
        data_type="OBJECT",
        object_code="CREEP_TEST_MATERIAL_HISTORY_N_D_T_RESULTS",
...
class CreepTestMaterialHistoryNDTResults(ObjectType):
    defs = ObjectTypeDef(
        code="CREEP_TEST_MATERIAL_HISTORY_N_D_T_RESULTS",
...
class CreepTestTestPiece(Sample):
    defs = ObjectTypeDef(
        code="CREEP_TEST_TEST_PIECE",
        description="""Test piece // Probekörper""",
        generated_code_prefix="CREEP_PIECE",
    )
...
class CreepTestTestPieceHolderSystem(Instrument):
    defs = ObjectTypeDef(
        code="CREEP_TEST_TEST_PIECE_HOLDER_SYSTEM",
        ...
        generated_code_prefix="CREEP_PIECE_HOLDE",
    )
...
class CreepTestTestMachineLoadingSystem(Instrument):
    ...
    creep_test_description_of_the_loading_system = PropertyTypeAssignment(
        ...
        property_label="Description of the loading system",
...
class CreepTestTestMachineDataAcquisition(Instrument):
    ...
    creep_test_data_acquisition_time_check = PropertyTypeAssignment(
        ...
        data_type="BOOLEAN",
        property_label="Data acquisition time check",
...
class CreepTestLoadSensor(Instrument):
    ...
    creep_test_load_sensor_calibration = PropertyTypeAssignment(
        ...
        data_type="BOOLEAN",
        property_label="Load sensor calibration",
...
class CreepTestLoadDataAcquisition(Instrument):
    ...
    creep_test_force_recording = PropertyTypeAssignment(
        ...
        data_type="VARCHAR",
        property_label="Force recording",
...
class CreepTestTemperatureMeasuringSystem(Instrument):
    defs = ObjectTypeDef(
        code="CREEP_TEST_TEMPERATURE_MEASURING_SYSTEM",
        ...
        generated_code_prefix="CREEP_TEMPE_MEASU",
    )
    ...
    creep_test_metrological_traceability = PropertyTypeAssignment(
        ...
        data_type="BOOLEAN",
        property_label="Metrological traceability",
...
class CreepTestTemperatureSensor(Instrument):
    defs = ObjectTypeDef(
        code="CREEP_TEST_TEMPERATURE_SENSOR",
        ...
        generated_code_prefix="CREEP_TEMPE_SENSO",
    )
    ...
    creep_test_calibration_status = PropertyTypeAssignment(
        ...
        data_type="BOOLEAN",
        property_label="Calibration status",
...
class CreepTestTemperatureDataAcquisition(Instrument):
    defs = ObjectTypeDef(
        code="CREEP_TEST_TEMPERATURE_DATA_ACQUISITION",
        ...
        generated_code_prefix="CREEP_TEMPE_DATA",
    )
    creep_test_calibration_status = PropertyTypeAssignment(
        code="CREEP_TEST_CALIBRATION_STATUS",
        data_type="BOOLEAN",
...
class CreepTestExtensionValuesContactingExtensometer(Instrument):
    defs = ObjectTypeDef(
        code="CREEP_TEST_EXTENSION_VALUES_CONTACTING_EXTENSOMETER",
        ...
        generated_code_prefix="CREEP_EXTEN_VALUE",
    )
    creep_test_measurement_set_up = PropertyTypeAssignment(
        ...
        property_label="Measurement set-up",
    ...
    creep_test_extension_averaging = PropertyTypeAssignment(
        ...
        property_label="Extension averaging",
...
class CreepTestElongationValuesAndCrossSectionalDimensions(Instrument):
    defs = ObjectTypeDef(
        code="CREEP_TEST_ELONGATION_VALUES_AND_CROSS_SECTIONAL_DIMENSIONS",
        ...
        generated_code_prefix="CREEP_ELONG_VALUE",
    )
...
class CreepTestPrimaryValuesRecordedDuringTestRun(CreepTestValuesRecordedDuringTestRunBase):
    defs = ObjectTypeDef(
        code="CREEP_TEST_PRIMARY_VALUES_RECORDED_DURING_TEST_RUN",
...
class CreepTestSecondaryValuesRecordedDuringTestRun(CreepTestValuesRecordedDuringTestRunBase):
    defs = ObjectTypeDef(
        code="CREEP_TEST_SECONDARY_VALUES_RECORDED_DURING_TEST_RUN",
        ...
        generated_code_prefix="CREEP_SECON_VALUE",
    )
